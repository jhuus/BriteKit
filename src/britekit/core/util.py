...
def compress_spectrogram(spec: torch.Tensor) -> bytes:
    """
...
def expand_spectrogram(spec: bytes) -> np.ndarray:
    """
...
def labels_to_dataframe(input_path: str) -> pd.DataFrame:
    """
    Given a directory containing Audacity label files generated by BriteKit, BirdNET or Perch,
...
def inference_output_to_dataframe(input_path: str) -> pd.DataFrame:
    """
