...
| `teacher_targets_pickle` | `Union[str, NoneType]` | None | Optional soft segment targets generated by the teacher-targets command |
| `distillation_weight` | `float` | 0.5 | Teacher share of segment loss |
| `distillation_temperature` | `float` | 1.0 |  |
| `teacher_only_if_no_frame` | `bool` | False |  |
...
| `max_per_recording_min_recordings` | `Union[int, NoneType]` | None | Do not limit specs for classes represented by fewer than this many recordings |
